...
namespace Assignment1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" program that takes two numbers as input and perform an operation (+,-,*,/) on them and displays the result of that operation.");

            Example3 ex3 = new Example3();
            ex3.oper();

            Console.WriteLine("*********Program 4************");
            Console.WriteLine("program which accepts marks of 5 students for c#,html, and sql and calculate average and print result passed or fail");
            ...
            Console.WriteLine("display temperature in celsius");
